...
#     bio = forms.Textarea()
#     role = forms.CharField(required=False, label=_("Role"))
#     company = forms.CharField(required=False, label=_("Company"))
#     verified = forms.BooleanField(required=True, label=_("Verified"))
...
#     address = forms.CharField(required=False, label=_("Residential address"))
